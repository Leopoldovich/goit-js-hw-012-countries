...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/@pnotify/countdown/dist/PNotifyCountdown.js":[function(require,module,exports) {
var define;
...
function hideElement() {
  _refs.default.countryInfo.style.display = 'none';
  _refs.default.countryList.style.display = 'none';
  removeEvent();
}

function getCountryFunc(name) {
  (0, _fetchCountries.default)(name).then(data => {
    if (data.length > 10) {
      (0, _PNotify.error)({
        title: 'Too many matches found.',
        text: 'Please entera morespecific query!'
      });
...
function setCountryList(data) {
  _refs.default.countryList.style.display = 'block';
  const list = data.map(el => `<li>${el.name}</li>`);
  _refs.default.countryList.innerHTML = list.join('');
  setEventCountry();
}

function setCountryInfo(data) {
  _refs.default.countryInfo.style.display = 'block';
  _refs.default.countryName.textContent = data.name;
  _refs.default.countryCapital.textContent = data.capital;
  _refs.default.countryPopulation.textContent = data.population;
  _refs.default.countryLangList.innerHTML = data.languages.map(el => `<li>${el.name}</li>`).join('');
  _refs.default.countryFlag.src = data.flag;
}

function onClickCountryItem(e) {
  _refs.default.formEl.elements.countryName.value = e.target.textContent;
  getCountryFunc(e.target.textContent);
  hideElement();
}

function setEventCountry() {
  _refs.default.countryList.addEventListener('click', onClickCountryItem);
}

function removeEvent() {
  _refs.default.countryList.removeEventListener('click', onClickCountryItem);
}
...
_refs.default.formEl.elements.countryName.addEventListener('input', debounce(onInputCountry, 500));
},{"./js/fetchCountries.js":"js/fetchCountries.js","./js/refs.js":"js/refs.js","debounce":"../node_modules/debounce/index.js","../node_modules/@pnotify/core/dist/PNotify.js":"../node_modules/@pnotify/core/dist/PNotify.js","../node_modules/@pnotify/mobile/dist/PNotifyMobile.js":"../node_modules/@pnotify/mobile/dist/PNotifyMobile.js","@pnotify/core/dist/PNotify.css":"../node_modules/@pnotify/core/dist/PNotify.css","@pnotify/core/dist/BrightTheme.css":"../node_modules/@pnotify/core/dist/BrightTheme.css","@pnotify/countdown":"../node_modules/@pnotify/countdown/dist/PNotifyCountdown.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7629" + '/');
